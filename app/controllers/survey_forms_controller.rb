class SurveyFormsController < ApplicationController
  ...
  private
    ...
    def survey_form_params
      params.require(:survey_form).permit(:side_id, :nama_site_id, :alamat, :kelurahan, :kecamatan, :kabupaten, :provinsi, :nama_lokasi, :lattide, :longitude, :jam_operasional, :id_pelanggan_listrik, :kapasitas, :lainnya_internet, :bandwidt_tersedia, :nama_operator_seluler, :kualitas_layanan, :jumlah_komputer, :perangkat_pendukung_lainnya, :nama_penanggung_jawab_lokasi_1, :kontak_penanggung_jawab_lokasi_1, :nama_penanggung_jawab_lokasi_2, :kontak_penanggung_jawab_lokasi_2, :keterangan_menuju_lokasi, :catatan_tambahan, :gambaran_menuju_lokasi, :surveyor, :project, :perangkat_lainnya,:kualitas_akses_internet, :photo_sketsa, :image_gedung, :image_rencana_tempat_perangkat, :image_genset, :image_lingkungan_depan, :image_lingkungan_belakang, :image_lingkungan_kiri, :image_lingkungan_kanan, :image_akses_ke_site, :image_akses_ke_site_1, :image_geotagging, :image_surveyor, :image_tambahan_photo_1, jenis_koneksi_1:[],  sumber_listrik:[], jenis_koneksi:[], transportasi_menuju_lokasi:[])
    end
end
